#ifdef defined(ARDUINO_ESP32C3_DEV)
  #pragma message "Found: ARDUINO ESP32C3 is defined!"
#endif
#ifdef ARDUINO_XIAO_ESP32C5
  #pragma message "Found: ARDUINO ESP32C5 is defined!"
#endif
#ifdef ARDUINO_XIAO_ESP32C6
  #pragma message "Found: ARDUINO ESP32C6 is defined!"
#endif
...
#define RX2 1  //Serial5 TX on T4.1
#define TX2 2  // Serial5 RX on T4.1
#endif
...
void loop() {
  ...
  if (Serial1.available()) {
    ...
    else if (commandLine == "CMD:ESPRESTART") {
